...
1. Explain the differences between `let`, `var`, and `const` in JavaScript. Provide examples of when to use each one.
    **Answer: 
    <!-- Const deyismez olaraq deklare olunur. var let ile declare etmek olur ayri ayriliqda . let de 2ci defe deyiseni deklare etmek olmur yeni deyisilmir error verir. has been declaret olaraq. var da ise use strict istifade ederek 2ci defe deklera olmaginin garsini almaq olar  -->
    **
